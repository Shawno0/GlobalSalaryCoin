...
"""Verify that starting globalsalarycoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start globalsalarycoin with -? for help text")
        ...
        self.log.info("Start globalsalarycoin with -version for version information")
