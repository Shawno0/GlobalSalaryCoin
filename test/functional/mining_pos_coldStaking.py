...
from test_framework.globalsalarycoin_node import PivxTestNode
...
class GlobalSalaryCoin_ColdStakingTest(PivxTestFramework):
...
if __name__ == '__main__':
    GlobalSalaryCoin_ColdStakingTest().main()
