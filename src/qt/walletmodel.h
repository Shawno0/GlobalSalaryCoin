...
#ifndef GlobalSalaryCoin_QT_WALLETMODEL_H
#define GlobalSalaryCoin_QT_WALLETMODEL_H
...
/** Interface to GlobalSalaryCoin wallet from Qt view code. */
...
#endif // GlobalSalaryCoin_QT_WALLETMODEL_H
