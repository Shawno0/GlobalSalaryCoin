...
/** Utility functions used by the GlobalSalaryCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GlobalSalaryCoin addresses in monospace font
...
// Parse "globalsalarycoin:" URI into recipient object, return true on successful parsing
