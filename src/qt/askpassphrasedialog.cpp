...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            GlobalSalaryCoinGUI* window = static_cast<GlobalSalaryCoinGUI*>(parentWidget());
...
{
    GlobalSalaryCoinGUI* gui = static_cast<GlobalSalaryCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<GlobalSalaryCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("GlobalSalaryCoin will close now to finish the encryption process. "
