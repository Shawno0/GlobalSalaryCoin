...
#ifndef GlobalSalaryCoin_CONSENSUS_ZEROCOIN_VERIFY_H
#define GlobalSalaryCoin_CONSENSUS_ZEROCOIN_VERIFY_H
...
#endif //GlobalSalaryCoin_CONSENSUS_ZEROCOIN_VERIFY_H
