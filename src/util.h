...
extern const char * const GlobalSalaryCoin_CONF_FILENAME;
extern const char * const GlobalSalaryCoin_PID_FILENAME;
extern const char * const GlobalSalaryCoin_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("globalsalarycoin-%s", name);
