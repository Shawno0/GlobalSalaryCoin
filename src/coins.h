...
// Copyright (c) 2016-2020 The GlobalSalaryCoin developers
...
public:
    ...
    /**
     * Amount of globalsalarycoin coming in to a transaction
...
// GlobalSalaryCoin: It assumes that overwrites are never possible due to BIP34 always in effect
