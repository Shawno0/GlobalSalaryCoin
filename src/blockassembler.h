...
// Copyright (c) 2021 The GlobalSalaryCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://www.opensource.org/licenses/mit-license.php.

#ifndef GlobalSalaryCoin_BLOCKASSEMBLER_H
#define GlobalSalaryCoin_BLOCKASSEMBLER_H
...
#endif // GlobalSalaryCoin_BLOCKASSEMBLER_H
