PIVX Core version *v4.0.0* is now available from:  <https://github.com/globalsalarycoin-project/globalsalarycoin/releases>
...
For our linux users, in addition to the [Ubuntu PPA](https://launchpad.net/~globalsalarycoin) repository, we are now offering a [Snap package](https://snapcraft.io/globalsalarycoin-core) as quick way to install and update a PIVX wallet.
