PIVX Core version *3.1.0* is now available from:  <https://github.com/globalsalarycoin-project/globalsalarycoin/releases>
...
### Summary
 ...
 The PIVX wallet can now have user selected directories for automatic backups of the wallet data file (wallet.dat). This can be set by adding the following lines to the globalsalarycoin.conf file, found in the PIVX data directory.
