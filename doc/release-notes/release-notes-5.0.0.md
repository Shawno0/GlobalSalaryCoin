GlobalSalaryCoin Core version *v5.0.0* is now available from:  <https://github.com/globalsalarycoin-project/globalsalarycoin/releases>
...
GlobalSalaryCoin Core v5.0.0 is a mandatory update for all users. This release contains a protocol upgrade (to `70920`), new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
See the release notes from [v4.2.0](https://github.com/GlobalSalaryCoin-Project/GlobalSalaryCoin/blob/master/doc/release-notes/release-notes-4.2.0.md#label-and-account-apis-for-wallet) for a full description of the changes from the 'account' API to the 'label' API.
...
| `getaccountaddress` | Returned the current GlobalSalaryCoin address associated with an internal account | Account system removal |
| `setaccount` | Associate a GlobalSalaryCoin address with an internal account name | Account system removal |
| `getaccount` | Returned the internal account associated with a given GlobalSalaryCoin address | Account system removal |
| `getaddressesbyaccount` | Returned a list of GlobalSalaryCoin addresses associated with an internal account | Account system removal |
...
| `sendfrom` | Send an amount from an internal account to a GlobalSalaryCoin address | Account system removal |
...
| `multisend` | Configure sending a portion of stake rewards to a GlobalSalaryCoin address | Pending a full rewrite |
...
### Build Systems
- #1856 `1bbb906059` [CMake] Add test_globalsalarycoin unit test target (Fuzzbawls)
...
- #2041 `a15dc3417d` [Build] CMake globalsalarycoind and unit tests: fixing missing MacOS framework. (furszy)
