UNIX BUILD NOTES
====================
Some notes on how to build GlobalSalaryCoin Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile GlobalSalaryCoin Core and the dependencies,
...
memory available when compiling GlobalSalaryCoin Core. On systems with less, gcc can be
...
To build GlobalSalaryCoin Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your GlobalSalaryCoin Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, GlobalSalaryCoin Core should be built with a non-executable stack
