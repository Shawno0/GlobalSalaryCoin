...
The script [extract-osx-sdk.sh](https://github.com/globalsalarycoin-project/globalsalarycoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
globalsalarycoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/globalsalarycoin-project/globalsalarycoin/blob/master/doc/README_osx.md) for troubleshooting tips.