Contributing to GlobalSalaryCoin Core
============================

The GlobalSalaryCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/globalsalarycoin-project/globalsalarycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GlobalSalaryCoin Core project, and is not to be
confused with overall GlobalSalaryCoin Network Protocol consensus changes.

Whether a pull request is merged into GlobalSalaryCoin Core rests with the project merge
...
Patches that change GlobalSalaryCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the GlobalSalaryCoin consensus, it must have been
...
The project leader is the release manager for each GlobalSalaryCoin Core release.
